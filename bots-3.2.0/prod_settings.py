...
MANAGERS = (    #bots will send error reports to the MANAGERS
    #('Alessandro Rubino', 'alessandro.rubino@aibert.it'),
    #('Francesco Carbone', 'francesco.carbone@ggteamwear.com'),
    ('Stefano Rosa', 's.rosa@wiredhub.io'),
    )
EMAIL_HOST = 'smtp.ggteamwear.com' #Default: 'localhost'
EMAIL_PORT = '587' #Default: 25
EMAIL_USE_TLS = True #Default: False
EMAIL_HOST_USER = 'repconnettore@ggteamwear.com' #Default: ''. Username to use for the SMTP server defined in EMAIL_HOST. If empty, Django won't attempt authentication.
EMAIL_HOST_PASSWORD = 'Rpcnnttr2023!' #Default: ''. PASSWORD to use for the SMTP server defined in EMAIL_HOST. If empty, Django won't attempt authentication.
SERVER_EMAIL = 'repconnettore@ggteamwear.com' #Sender of bots error reports. Default: 'root@localhost'
EMAIL_SUBJECT_PREFIX = '[Connettore]' #This is prepended on email subject.
